      ...
      <div class="col-12 col-md-4 col-lg-4">
        <article class="article article-style-c">
          <div class="article-header">
            <div class="article-image" data-background="{{$d['foto']}}" style="background-image: url(&quot;assets/img/news/img01.jpg&quot;);">
            </div>
          </div>
          <div class="article-details">
            ...
            <div class="article-title">
              <h2><a href="{{route('show-kegiatan',['slug' => $d->slug])}}">{{$d['judul']}}</a></h2>
            </div>
          </div>
        </article>
      </div>
